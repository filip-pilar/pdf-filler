...
interface PositionPickerState {
  ...
  pickingActionType: 'checkmark' | 'fillLabel' | 'fillCustom' | null;
  ...
  startPicking: (params: {
    ...
    content: string;
    optionLabel: string;
    actionType?: 'checkmark' | 'fillLabel' | 'fillCustom';
...
export const usePositionPickerStore = create<PositionPickerState>((set, get) => ({
  ...
  startPicking: ({ actionId, content, optionLabel, actionType, onComplete, onCancel }) => {
    set({
